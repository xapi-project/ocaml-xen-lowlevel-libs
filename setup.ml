...
(* OASIS_START *)
(* DO NOT EDIT (digest: d241d221202ecfdf620952b1050c166a) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the xenlight bindings for xen-4.4";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the xenguest helper for xen-4.2";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "xenlight44", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "xentoollog-4.4";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "xenlight-4.4";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xentoollog44"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "xenguest42",
                                OASISExpr.EFlag "xenctrl"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "xenguest-4.2";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {
                      lib_modules = ["Xenguest"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenguest42";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\007\212\148\139H\171\030\1959\152h\156\148\150\145\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

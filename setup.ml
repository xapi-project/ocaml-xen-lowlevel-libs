...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8ea87d1df45e1d3a0dbe8feb3f55e88d) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the xenlight bindings for xen";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "3\011\194\143\b\189\172(@\234Q\223\209\233\241\254";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

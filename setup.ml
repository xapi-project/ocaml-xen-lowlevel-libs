...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3caddef4c3e360402aa29ae5b33c364b) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["xenmmap_stubs.c"; "mmap_stubs.h"; "xenctrl_stubs.c"
                        ];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "xenguest42", true)
                        ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\153\145\248\128\173\183\005a\173\163k\202h$3\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

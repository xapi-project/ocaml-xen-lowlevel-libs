...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3e78a39f3ec953bc3c80a21afcffb23a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("uuidm", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["mmap_stubs.c"; "mmap_stubs.h"; "xc_stubs.c"];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\005\155\027)r\024p\007\185\218j1\028\156\007\030";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13f58bec7eb9a00fe3c7b812fef585c7) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["xenlight_stubs.c"; "caml_xentoollog.h"; "config.h"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\164\2447\b\130\240\162-\223\200!\223\164\249@\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

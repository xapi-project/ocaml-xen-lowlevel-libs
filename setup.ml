...
(* OASIS_START *)
(* DO NOT EDIT (digest: a0e07e5d8e5e34d1f8cbb13eaa2f59f2) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Gnt"; "Eventchn"; "Xenmmap"; "Xenctrl"; "Xenguest"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xen_event";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "KP\213\024\138[\173\253\185#\230\161\214_\161\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

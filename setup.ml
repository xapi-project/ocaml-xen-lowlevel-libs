...
(* OASIS_START *)
(* DO NOT EDIT (digest: a20cd53798b59aeb2ac4fd37c391a064) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eventchn"; "Generation"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xen-event";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xen_event_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xen-event-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "grant";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("io-page", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xen-grant";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xen_grant_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xen_grant";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\167B\133do`Lt\161JV\1682a\003\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

...
(* OASIS_START *)
(* DO NOT EDIT (digest: c08dc1edd2fdb2deb5e0cccefc46659e) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "link with -lxentoollog, required for newer xen versions";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "compile test_hvm_check_provider";
                      ...
                      bs_cclib =
                        [
                           ...
                           (OASISExpr.EFlag "xentoollog",
                             ["-lxenctrl"; "-lxenguest"; "-lxentoollog"]);
     ...
     oasis_digest =
       Some "l\015\177u\220o\184\249\233\144\024K\149\230\024\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

(* OASIS_START *)
(* DO NOT EDIT (digest: cd28f0de9e68c52879e236c8140bcb26) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ...
          ("xenctrl_lwt", ["lwt"], []);
          ("xen_event", ["event"], []);
          ("xen_event_unix", ["event_unix"], []);
          ("xen_grant", ["grant"], []);
          ("xen_grant_unix", ["grant"], []);
          ("xenlight", ["xenlight"], []);
          ("xentoollog", ["xenlight"], [])
       ];
     lib_c =
     ...
     flags =
       [
          ...
          (["oasis_library_xen_event_unix_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_xen_event_unix_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_xen_event_unix_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S [A "-L/usr/lib/xen-4.2/lib"; A "-lxenctrl"])
            ]);
          (["oasis_library_xen_grant_unix_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_xen_grant_unix_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_xen_grant_unix_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S [A "-L/usr/lib/xen-4.2/lib"; A "-lxenctrl"])
            ]);
